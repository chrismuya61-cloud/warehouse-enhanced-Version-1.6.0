                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            <p><?php echo _l('commodity_name'); ?>: <strong><?php echo isset($item) ? $item->description : ''; ?></strong></p>
                            <p><?php echo _l('serial_number'); ?>: <strong><?php echo isset($serial_number) ? $serial_number : 'N/A'; ?></strong></p>
                        </div>
